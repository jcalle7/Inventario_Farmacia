...
export default function EditFormaModal({open, handleClose, onSave} : {open: boolean; handleClose: () => void; onSave: () => void; }) {
  ...
  return (
      ...
      >
        <DialogTitle id="form-dialog-title">Editar Forma del Fármaco</DialogTitle>
        <DialogContent>
          {/* Inputs de texto */}
          <Box
            component="form"
