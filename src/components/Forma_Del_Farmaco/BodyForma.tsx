...
import '../../CSS/Forma_Del_Farmaco/BodyForma.css';
import { EditButtonForma } from '../Forma_Del_Farmaco/ButtonsForma';
import { useState } from 'react';

type DataTableFormaProps = {
  onEditClick: (id: number) => void;
};

export default function DataTableForma({ onEditClick }: DataTableFormaProps) {
  ...
  const rows = Array.from({ length: 60 }).map((_, i) => ({
    ...
    nombre: 'Agua Micelar',
    estado: 'Disponible',
    VíadeAdministración: 'Comprimido'
  }));
