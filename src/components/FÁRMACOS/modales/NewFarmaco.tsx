...
export default function NewFarmacoModal({open, handleClose, onSave} : {open: boolean; handleClose: () => void; onSave: () => void; }) {
  ...
  return (
      ...
      >
        <DialogTitle id="form-dialog-title">Mantenimiento de Fármacos</DialogTitle>
        <DialogContent>
