...
interface AddViaAdministracionProps {
  open: boolean;
  onClose: () => void;
  onConfirm: () => void;
}

const AddViaAdministracion = ({ open, onClose, onConfirm }: AddViaAdministracionProps) => {
...
const datos = [
    ...
    return(
        ...
        <DialogTitle>Añadir Vía de Administración</DialogTitle>
...
export default AddViaAdministracion;