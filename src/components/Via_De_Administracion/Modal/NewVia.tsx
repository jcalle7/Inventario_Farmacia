...
export default function NewViaModal({open, handleClose, onSave} : {open: boolean; handleClose: () => void; onSave: () => void; }) {
  ...
  return (
    ...
    >
        <DialogTitle id="form-dialog-title">Crear Nueva Vía de Administración</DialogTitle>
        <DialogContent>
          {/* Inputs de texto */}
          <Box
            component="form"
