...
import { EditButtonTipoMovimiento } from './ButtonsTipoMovimiento';

type DataTableTipoMovimientoProps = {
  onEditClick: (id: number) => void;
};

export default function DataTableTipoMovimiento({ onEditClick }: DataTableTipoMovimientoProps) {
