...
export default function EditTipoMovimientoModal({open, handleClose, onSave} : {open: boolean; handleClose: () => void; onSave: () => void; }) {
  ...
  return (
      ...
      >
        <DialogTitle id="form-dialog-title">Editar Tipo de Movimiento</DialogTitle>
        <DialogContent>
          {/* Inputs de texto */}
          <Box
            component="form"
