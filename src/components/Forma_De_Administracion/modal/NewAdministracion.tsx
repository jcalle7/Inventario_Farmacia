...
export default function NewAdministracionModal({open, handleClose, onSave} : {open: boolean; handleClose: () => void; onSave: () => void; }) {
  ...
  return (
      ...
      >
        <DialogTitle id="form-dialog-title">Crear Nueva Forma de Administración</DialogTitle>
        <DialogContent>
          {/* Inputs de texto */}
          <Box
            component="form"
