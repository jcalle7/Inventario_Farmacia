...
function createData(id: number, startDate: string, endDate: string) { 
...
export default function NewListaPreciosModal({open, handleClose, onSave} : {open: boolean; handleClose: () => void; onSave: () => void; }) {
  ...
  return (
    <>
      <Dialog open={open} onClose={handleClose} maxWidth={false} slotProps={{ paper: {sx: { width: '80%', height: '80%' } }}}>
        <DialogTitle id="form-dialog-title">Crear Nueva Lista de Precios</DialogTitle>
        <DialogContent>
