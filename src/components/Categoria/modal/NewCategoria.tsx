...
export default function NewCategoriaModal({open, handleClose, onSave} : {open: boolean; handleClose: () => void; onSave: () => void; }) {
  ...
  return (
      ...
      >
        <DialogTitle id="form-dialog-title">Crear Nueva Categoría</DialogTitle>
        <DialogContent>
          {/* Inputs de texto */}
          <Box
            component="form"
