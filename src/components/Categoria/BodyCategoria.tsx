...
import { EditButtonCategoria } from '../Categoria/ButtonsCategoria';
import { useState } from 'react';

type DataTableCategoriaProps = {
  onEditClick: (id: number) => void;
};

export default function DataTableCategoria({ onEditClick }: DataTableCategoriaProps) {
