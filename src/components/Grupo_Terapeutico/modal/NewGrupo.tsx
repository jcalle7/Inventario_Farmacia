...
export default function NewGrupoModal({open, handleClose, onSave} : {open: boolean; handleClose: () => void; onSave: () => void; }) {
  ...
  return (
    ...
    >
        <DialogTitle id="form-dialog-title">Crear Nuevo Grupo Terapéutico</DialogTitle>
        <DialogContent>
          {/* Inputs de texto */}
          <Box
            component="form"
